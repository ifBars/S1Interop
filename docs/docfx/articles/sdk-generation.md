...
- a migration found reflection code that needs a stable generated target, such as a cached `FieldInfo`, `PropertyInfo`, `AccessTools.Field(typeof(...), "...")`, or `AccessTools.Property(typeof(...), "...")` binding in a mod.
